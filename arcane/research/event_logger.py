...
class EventLogger:
    ...
    def __init__(self, log_dir: str = "logs", max_buffer_size: int = 500):
    ...
    def log_info_revealed(self, step: int, sim_time: str, agent_id: str,
        ...
        self.log(SimEvent(
            ...
            content=f"INFORMATION REVEALED ({sensitivity}): {info_type}",
            metadata={"info_type": info_type, "sensitivity": sensitivity},
        ))
